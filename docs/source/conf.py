...
from plotstyle import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "plotstyle"
copyright = f"{datetime.today().year}, Simon Mathis"
author = "Simon Mathis"
...
html_title = f"plotstyle v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/Croydon-Brixton/plotstyle",
            "html": """
